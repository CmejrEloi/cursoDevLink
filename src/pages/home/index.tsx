...
export function Home() {
    ...
    const [socialLinks, setSocialLinks] = useState<SocialLinksPropos>();
    ...
    return (
        <div className="flex flex-col w-full py-4 items-center justify-center">
            <h1 className="md:text-4xl text-3xl font-bold text-white mt-20">Cláudio Junior</h1>
            <span className="text-gray-50 mb-5 mt-3">Veja meu links 👇</span>
